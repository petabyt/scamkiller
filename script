...
It mainly started with a data breach, in which the scammer took anvantage of
and infected.
...
The domain they use is "rblx.link". I tracked the hosting provider to
...
video to a new port on the same domain. 
I then returned by reporting the abusive website to the new host. They didn't respond.
...
While this was running, I started other investigations.
